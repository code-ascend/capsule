...
function __capsule_perform_completion
    ...
    for line in $results
        if not string match -q -- "capsule*" $line
...
# Clear existing completions for capsule
complete -c capsule -e
# Register completion function
complete -c capsule -f -a '(__capsule_perform_completion)'
